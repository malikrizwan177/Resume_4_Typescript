...
const Hero: React.FC = () => {
  const textChange: string[] = ["Software Engineer", "React Developer"];
      ...
      <div className="flex flex-col md:flex-row-reverse gap-10 justify-between items-center max-w-[1440px] mx-auto">
        ...
        <div className="flex flex-col justify-center items-start gap-3 md:gap-5 max-w-[620px]">
          ...
          <p className="mr-0 md:mr-20">
            I'm a React Web application developer with experience in building
            responsive and optimized web application using the latest
            technologies and practices in a remote environment for a year and a
            half and now on-site for half a year. I've worked on different kind
            of projects such as SPA's, landing pages, e-commerce while keeping
            the design as per provided by the UI/UX team.
          </p>
          <a href="#contact">
