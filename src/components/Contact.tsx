...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const budgetNumber = form.budget ? Number(form.budget) : 0;
        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start gap-10">
            <div className="max-w-[350px] lg:max-w-[400px]">
              ...
              <p>
                Let's connect and build amazing and eye-catching websites
                together using the latest Technologies such as React and
                TailwindCSS{" "}
              </p>
